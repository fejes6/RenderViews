function IllustrativeRenderer(domQuery) {
    ...
    //***********
        ...
        for (var f = 0, fl = self.pickedMaterial.geometry.faces.length; f < fl; f++) {
        var face = self.pickedMaterial.geometry.faces[ f ];
        var centroid = new THREE.Vector3(0, 0, 0);
        centroid.add(self.pickedMaterial.geometry.vertices[face.a]);
        centroid.add(self.pickedMaterial.geometry.vertices[face.b]);
        centroid.add(self.pickedMaterial.geometry.vertices[face.c]);
